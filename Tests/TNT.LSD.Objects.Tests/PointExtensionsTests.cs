...
public class PointExtensionsTests
{
  ...
  [Test]
  public void ToPageCoordinateSpaceTest()
  {
    Bitmap b = new Bitmap(100, 100);
    Graphics g = Graphics.FromImage(b);
    g.ScaleTransform(2, 2);
    var origPoint = new Point(30, 42);

    var newPoint = origPoint.ToPageCoordinateSpace(g, false);
    Assert.That(newPoint, Is.EqualTo(new Point(60, 84)));

    newPoint = origPoint.ToPageCoordinateSpace(g, true);
    Assert.That(newPoint, Is.EqualTo(new Point(64, 88)));
  }
