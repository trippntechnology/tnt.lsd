...
public static class Global
{
    ...
    public static void CheckForUpdate(IWin32Window owner, bool showOnlyIfExists = true)
    {
        try
        {
            ...
            {
                MessageBox.Show(owner, "The updater executable could not be found. Please reinstall the application to enable update functionality.", "Updater Not Found", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
