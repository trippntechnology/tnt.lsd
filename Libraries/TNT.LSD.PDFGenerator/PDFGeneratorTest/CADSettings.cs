...
namespace PDFGeneratorTest
{
	public class CADSettings
	{
		...
		virtual public int HeightInFeet
		{
			...
			set { m_HeightInFeet = value > MAX_WIDTH_HEIGHT ? MAX_WIDTH_HEIGHT : value; }
		}
		...
		virtual public int WidthInFeet
		{
			...
			set { m_WidthInFeet = value > MAX_WIDTH_HEIGHT ? MAX_WIDTH_HEIGHT : value; }
		}
