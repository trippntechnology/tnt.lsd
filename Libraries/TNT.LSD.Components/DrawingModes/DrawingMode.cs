...
public abstract class DrawingMode
{
  ...
  public virtual TNTObject DefaultObject
  {
  ...
  public virtual void OnMouseMove(TNTCAD cad, MouseEventArgs e, Keys modifierKeys) { }
  public virtual void OnMouseUp(TNTCAD cad, MouseEventArgs e, Keys modifierKeys) { }
  public virtual void OnMouseDown(TNTCAD cad, MouseEventArgs e, Keys modifierKeys) { }
  public virtual void OnMouseDoubleClick(TNTCAD cad, MouseEventArgs e) { }
  public virtual void OnMouseClick(TNTCAD cad, MouseEventArgs e, Keys modifierKeys) { }
  public virtual void OnKeyDown(TNTCAD cad, KeyEventArgs e) { }
  public virtual void OnKeyUp(TNTCAD cad, KeyEventArgs e) { }

  public abstract DrawingMode Clone();

  /// <summary>
  /// Resets members to defaults
  /// </summary>
  public virtual void Reset(TNTCAD cad)
  {
    m_PointerPoint = null;
    UndoEnabled = true;
  }
  ...
  protected virtual void DrawPointerPoint(Graphics g, Point pos, DrawingOptions drawingOptions)
  {
  ...
  public virtual string[] DefaultObjects()
  {
