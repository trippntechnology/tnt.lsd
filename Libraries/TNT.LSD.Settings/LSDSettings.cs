...
public class LSDSettings
{
  ...
  protected string m_TelephoneNumber = string.Empty;
  ...
  [JsonIgnore]
  virtual public OnDrawLayersDelegate OnDrawLayers { private get; set; } = delegate { };
  [JsonIgnore]
  virtual public OnSetHeightInFeetDelegate OnSetHeightInFeet { private get; set; } = delegate { };
  [JsonIgnore]
  virtual public OnSetWidthInFeetDelegate OnSetWidthInFeet { private get; set; } = delegate { };
