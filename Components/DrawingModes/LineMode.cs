...
namespace LSDComponents.DrawingModes
{
	public class LineMode : DrawingMode
	{
		...
		public override void OnMouseClick(TNTCAD cad, MouseEventArgs e, Keys modifierKeys)
		{
			...
			{
				TNTLine line = m_ConstructedObject as TNTLine;
		...
		virtual protected void DrawLine(TNTCAD cad, Point currentPos)
		{
			TNTLine line = m_ConstructedObject as TNTLine;
		...
		virtual protected Point AdjustToNearestAngleModulus(Point previous, Point current, double angleModulus, bool snapToGrid)
		{
